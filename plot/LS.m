% MIMO Channel Estimation using Least Squares (LS) Algorithm
% Signal model: y = Hx + n
% Author: DoHaiSon
% Date: 2025-01-19
...
for snr_idx = 1:length(SNR_dB)
    ...
    for exp = 1:num_experiments
        ...
        H_est = Y * pilot_symbols' * pinv(pilot_symbols * pilot_symbols');
...
% Plot results
figure;
semilogy(SNR_dB, NMSE, 'bo-', 'LineWidth', 1.5);
grid on;
xlabel('SNR (dB)');
ylabel('NMSE');

save('./assets/NMSE_LS.mat', 'NMSE');